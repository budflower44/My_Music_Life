...
@MapperScan(basePackages = {"com.mml.www.repository"})
@ComponentScan(basePackages = {"com.mml.www.service", "com.mml.www.exception"})
...
public class RootConfig {
	...
	public DataSource dataSource() {
		...
		hikariConfig.setJdbcUrl("jdbc:log4jdbc:mysql://localhost:3306/mml");
		hikariConfig.setUsername("mmlUser");
		hikariConfig.setPassword("mymusiclife");
